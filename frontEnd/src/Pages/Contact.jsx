    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 relative">
      ...
      <div className="bg-gray-700 bg-opacity-70 bg-blend-overlay bg-center bg-cover py-28" 
        ...
        <div className="container mx-auto px-4 text-center text-white">
          <h1 className="font-[cursive] text-5xl md:text-6xl font-bold mb-6 drop-shadow-lg">Contact Us</h1>
          <p className="font-[cursive] text-xl md:text-2xl max-w-3xl mx-auto">"Are you looking for a classic car or interested in selling your car? We are here to help you achieve your dream."</p>
        </div>
      </div>

      {/* Contact Section */}
      <div className="py-16 px-4 max-w-7xl mx-auto">
        <div className="shadow-xl shadow-green-300/40 bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-8 md:p-12">
              <h2 className="font-[cursive] text-3xl font-bold mb-6 dark:text-white">Contact Us</h2>
              <p className="font-[cursive] text-gray-600 dark:text-gray-300 mb-8">Have questions about a specific vehicle or need assistance? Our classic car experts are ready to help.</p>
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  <Phone size={20} className="text-green-600 mr-4" />
                  <span className="font-[cursive] dark:text-white">+962787491703</span>
                </div>
                <div className="flex items-center">
                  <Mail size={20} className="text-green-600 mr-4" />
                  <span className="font-[cursive] dark:text-white">Abdullahbainghanem@gmail.com</span>
                </div>
                <div className="flex items-center">
                  <Map size={20} className="text-green-600 mr-4" />
                  <span className="font-[cursive] dark:text-white">123 Vintage Lane, Los Angeles, CA 90001</span>
                </div>
              </div>
              <div className="flex space-x-4">
                <a href="https://web.facebook.com/?_rdc=1&_rdr#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                  <span className="font-[cursive] sr-only">Facebook</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                  </svg>
                </a>
                <a href="#" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                  <span className="font-[cursive] sr-only">Instagram</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://x.com/classic_ca?lang=ar" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                  <span className="font-[cursive] sr-only">Twitter</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://www.youtube.com/watch?v=fGt2a7UnJ6s" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                  <span className="font-[cursive] sr-only">YouTube</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
                  </svg>
                </a>
                {/* زر WhatsApp جديد */}
                <a href="https://wa.me/+962787491703" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center hover:bg-green-600 hover:text-white transition">
                  <span className="font-[cursive] sr-only">WhatsApp</span>
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="shadow-xl shadow-green-300/40 bg-gray-100 dark:bg-gray-700 p-8 md:p-12">
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  <label className="font-[cursive] block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Your Name</label>
                  <input 
                    type="text" 
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="font-[cursive] block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email Address</label>
                  <input 
                    type="email" 
                    name="email"
                ...
                <div>
                  <label className="font-[cursive] block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Message</label>
                  <textarea 
                    rows={4} 
                    name="message"
                ...
                <button type="submit" className="font-[cursive] w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition">
                  Send Message
                </button>
              </form>
            </div>
      ...
      <div className="w-full py-16 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="font-[cursive] text-4xl text-center text-green-600 font-bold mb-12">
          ...
          <div className="max-w-3xl mx-auto">
            {faqData.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3 className="font-[cursive] text-xl font-semibold text-left text-gray-800 dark:text-gray-200">
                    {faq.question}
                  </h3>
                  {expandedFaq === index ? 
