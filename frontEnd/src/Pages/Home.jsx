...
function Home() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 text-center w-full max-w-4xl px-4">
          <motion.h1
            ...
            className="font-[cursive] text-white font-cursive text-6xl md:text-7xl lg:text-8xl font-bold mb-6"
          >
            Driven By Drivers
          </motion.h1>
          <motion.p
            ...
            className="font-[cursive] text-white text-xl md:text-2xl mb-8 max-w-2xl mx-auto"
          >
      ...
      >
        <h2 className="font-[cursive] text-4xl font-cursive font-bold mb-6 dark:text-white">Welcome to Classic</h2>
        <p className="font-[cursive] text-xl font-cursive dark:text-gray-300 mb-6 leading-relaxed">
          ...
          {featuredCars.map(car => (
            ...
            >
              <div className="relative">
                ...
                <div className="font-[cursive] absolute top-3 right-3 bg-green-700 text-white py-1 px-3 rounded-full text-sm font-semibold">
                  Featured
                </div>
              </div>
              <div className="p-6">
                ...
                <a href={`/vehicles/${car.id}`} className="font-[cursive] block w-full bg-green-700 hover:bg-green-800 text-white text-center py-3 rounded-lg font-semibold transition">
                  View Details
                </a>
              </div>
            </motion.div>
      ...
      <div className="py-16 bg-gray-100 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="font-[cursive] text-5xl font-bold text-center mb-12 dark:text-white">Our Specialized Services</h2>
      ...
      <div className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="font-[cursive] text-5xl font-bold text-center mb-12 dark:text-white">What Our Clients Say</h2>
      ...
      <div className="bg-green-800 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-[cursive] text-3xl font-bold text-white mb-4">Stay Updated</h2>
          <p className="font-[cursive] text-white/90 mb-8 text-lg">Subscribe to our newsletter for exclusive updates on new inventory, special events, and classic car insights.</p>
