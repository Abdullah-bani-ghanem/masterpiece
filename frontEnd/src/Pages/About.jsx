    ...
    <>
      ...
      <div className="bg-gray-700 bg-opacity-70 bg-blend-overlay bg-center bg-cover py-28" 
        ...
        <div className="container mx-auto px-4 text-center text-white">
          <h1 className="font-[cursive] text-5xl md:text-6xl font-bold mb-6 drop-shadow-lg">About Us</h1>
          <p className="font-[cursive] text-xl md:text-2xl max-w-3xl mx-auto">"Whether you're searching for your dream classic car or ready to sell, we're here to make your journey effortless and memorable."</p>
        </div>
      </div>
        ...
        <div className="w-full h-full flex flex-col justify-center items-center sm:px-4 px-2">
          <div className="lg:w-[90%] w-full mx-auto flex flex-col lg:gap-6 lg:flex-row items-center justify-center ">
            ...
            <div className="lg:w-[60%] p-4 w-full h-full shadow-xl shadow-green-300/40 flex flex-col justify-center items-center sm:px-6 px-4 rounded-xl">
              <h2 className="font-[cursive] text-4xl text-center text-green-600 font-bold px-4 py-1 md:mt-0 mt-10">
                About Us
              </h2>
              <p className="font-[cursive] md:text-3xl text-2xl text-center text-gray-800 dark:text-gray-200 font-bold my-5">
