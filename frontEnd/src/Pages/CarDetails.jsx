...
const CarDetails = () => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-black">
                <div className="text-amber-300 text-xl font-serif">
                    Vehicle not found or data unavailable
                </div>
            </div>
        );
    }
    ...
    const handleEditComment = (commentId, existingComment) => {
        ...
        setEditedComment(existingComment);  // Set the current comment text for editing
    };
    ...
    return (
        <div className="bg-gradient-to-b from-gray-900 to-black min-h-screen pt-12 pb-20">
                        ...
                        <div className="mb-12">
                            ...
                            <div className="bg-gray-800 bg-opacity-50 rounded-lg p-6 border border-gray-700 mb-6">
                                <textarea
                                    ...
                                    className="w-full h-20 p-4 text-white bg-gray-700 rounded-md border border-gray-600 focus:border-amber-300 focus:ring-1 focus:ring-amber-300 focus:outline-none transition duration-300 resize-none mb-4"
                                ></textarea>
                                <button
                            ...
                            <div className="space-y-6">
                                {comments.length > 0 ? (
                                            ...
                                            <div className="flex items-center mb-3">
                                                ...
                                                <div>
                                                    <h4 className="text-white font-medium">
                                                        {comment.user && comment.user.username ? comment.user.username : 'Anonymous User'}
                                                    </h4>
                                            ...
                                            {editingCommentId === comment._id ? (
                                                <div className="mb-3">
                                                    <textarea
                                                        ...
                                                        className="w-full h-20 p-4 text-white bg-gray-700 rounded-md border border-gray-600 focus:border-amber-300 focus:ring-1 focus:ring-amber-300 focus:outline-none transition duration-300 resize-none"
                                                    ></textarea>
                                                    <button
                                                        onClick={handleUpdateComment}
                                                        className="bg-amber-300 hover:bg-amber-400 text-black font-medium py-2 px-6 rounded-md transition duration-300"
                                                    >
                                                        Update Comment
                                                    </button>
                                                </div>
                                    ...
                                    <div className="bg-gray-800 bg-opacity-30 rounded-lg p-8 border border-gray-700 text-center">
