        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-800 py-10 px-4">
            ...
            <div className="max-w-3xl mx-auto bg-white dark:bg-gray-700 rounded-lg shadow-lg p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Image Upload */}
                    <div>
                        <label htmlFor="carImage" className="block text-sm font-[cursive] text-gray-700 dark:text-gray-200">Upload Car Images</label>
                        <input
                            type="file"
                            id="carImage"
                            accept="image/*"
                        ...
                        {imagePreviews.length > 0 && (
                            <div className="grid grid-cols-2 gap-2 mt-4">
                                {imagePreviews.map((src, index) => (
                                    <img key={index} src={src} alt={`Preview ${index}`} className="w-full h-auto rounded-md shadow-md" />
                                ))}
                            </div>
                        )}
                    </div>
